...
| Page | Contents |
|---|---|
| [Usage](docs/usage.md) | Running the script, command-line examples, Windows Server media, slimming the ISO by removing editions, and building several Windows versions side by side. |
